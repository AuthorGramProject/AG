...
public class AGAppearanceSettingsActivity extends BaseAGXSettingsActivity {
    ...
    private final AbstractConfigCell drawerElementsRow = cellGroup.appendCell(new ConfigCellTextCheckIcon(null, "DrawerElements", getString(R.string.DrawerElements), R.drawable.menu_newfilter, false, () ->
            showDialog(showConfigMenuWithIconAlert(this, R.string.DrawerElements, new java.util.ArrayList<>() {{
                ...
                add(new ConfigCellTextCheckIcon(NaConfig.INSTANCE.getDrawerItemRecentChats(), getString(R.string.RecentChats), R.drawable.msg_recent));
                ...
                add(new ConfigCellTextCheckIcon(NaConfig.INSTANCE.getDrawerItemNSettings(), getString(R.string.AGSettings), R.drawable.ag_settings));
    ...
    public AGAppearanceSettingsActivity() {
    ...
    private void animateActionBarUpdate(BaseAGXSettingsActivity fragment) {
        ...
        protected View onCreateCustomViewHolder(@NonNull ViewGroup parent, int viewType) {
            return switch (viewType) {
                case ConfigCellCustom.CUSTOM_ITEM_AvatarCorners -> avatarCornersPreviewCell = new AvatarCornersPreviewCell(
                        mContext,
                        AGAppearanceSettingsActivity.this::reloadAvatarCorners
                );
