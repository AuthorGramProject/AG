...
public class AGEmojiSettingsActivity extends BaseAGSettingsActivity implements EmojiHelper.EmojiPackLoadListener, EmojiHelper.EmojiPacksLoadedListener, ChatAttachAlertDocumentLayout.DocumentSelectActivityDelegate {
    ...
    protected void onItemClick(View view, int position, float x, float y) {
        if (position >= emojiPacksStartRow && position < emojiPacksEndRow) {
            ...
            chatAttachAlert = new ChatAttachAlert(getParentActivity(), AGEmojiSettingsActivity.this, false, false);
        ...
        private void processSelectionMenu(int which) {
            ...
            if (count > 1) {
                ...
                if (which == menu_share) {
                    ...
                    EmojiHelper.getInstance().cancelableDelete(AGEmojiSettingsActivity.this, pack, new EmojiHelper.OnBulletinAction() {
                        @Override
