...
//        TLRPC.StickerSet stickerSet = messages_stickerSet.set;
    ...
    public ArrayList<TLRPC.MessageEntity> getEntities(CharSequence[] message, boolean allowStrike, boolean parseMarkdown) {
        ...
        while (
                parseMarkdown
                        && NaConfig.INSTANCE.getMarkdownParser().Int()
                                == NekoConfig.MARKDOWN_PARSER_TELEGRAM
                        && (
                                index = TextUtils.indexOf(
                                        message[0],
                                        !isPre ? mono : pre,
                                        lastIndex
                                )
...
//                }
        ...
        cs = parsePattern(
                ...
                BOLD_PATTERN,
                entities,
                obj -> new TLRPC.TL_messageEntityBold()
        );
        ...
        cs = parsePattern(
                ...
                ITALIC_PATTERN,
                entities,
                obj -> new TLRPC.TL_messageEntityItalic()
        );
        ...
        cs = parsePattern(
                ...
                SPOILER_PATTERN,
                entities,
                obj -> new TLRPC.TL_messageEntitySpoiler()
        );
        ...
        if (allowStrike) {
            cs = parsePattern(
                    ...
                    STRIKE_PATTERN,
                    entities,
                    obj -> new TLRPC.TL_messageEntityStrike()
            );
        }
