...
/**
 * One-window AuthorGram per-chat encryption controller.
 *
 * The same menu action creates or rotates a chat-specific key, enables encryption,
 * and disables encryption. The passphrase is cleared immediately and never stored.
 */
