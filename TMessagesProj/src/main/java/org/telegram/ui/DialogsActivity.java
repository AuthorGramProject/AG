    ...
    public View createView(final Context context) {
        ...
        if (onlySelect) {
            ...
            if (folderId != 0) {
                ...
                actionBar.setAdditionalTextLeft(
                        dp(28)
                );

                communityAvatarDrawable =
                        new AvatarDrawable(
                                community
                        );
                ...
                communityAvatarImage.setRoundRadius(
                        dp(11)
                );

                communityAvatarImage.setForUserOrChat(
                        community,
                        communityAvatarDrawable
                );
            ...
            public void onItemClick(int id) {
                ...
                if (id == -1) {
                    if (rightSlidingDialogContainer != null && rightSlidingDialogContainer.hasFragment()) {
                        ...
                        var drawerLayoutContainer =
                                getHomeDrawerContainer();

                        if (drawerLayoutContainer != null) {

                            if (drawerLayoutContainer
                                    .isDrawerOpened()) {
