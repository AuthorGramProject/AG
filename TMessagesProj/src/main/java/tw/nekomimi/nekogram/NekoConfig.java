...
public class NekoConfig {
    ...
    public static ConfigItem dataSaverMode = addConfig("dataSaverMode", configTypeBool, false);
    ...
    public static ConfigItem iOSMessageMenu = addConfig("iOSMessageMenu", configTypeBool, false);
    ...
    public static ConfigItem customSavePath = addConfig("customSavePath", configTypeString, "AuthorGram");
